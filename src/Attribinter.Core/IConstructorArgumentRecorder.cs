...
public interface IConstructorArgumentRecorder<in TPayload>
{
    /// <summary>Attempts to record data about an argument of a constructor parameter.</summary>
    /// <param name="parameter">The constructor parameter associated with the argument.</param>
    ...
    public abstract bool TryRecordData(IParameterSymbol parameter, TPayload payload);
}
